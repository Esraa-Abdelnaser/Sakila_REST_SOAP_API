...
public class CategoryMapperImpl implements CategoryMapper {
    ...
    public Category partialUpdate(CategoryDto categoryDto, Category category) {
        ...
        if ( category.getFilmCategoryList() != null ) {
            List<FilmCategory> list = filmCategoryDtoListToFilmCategoryList( categoryDto.getFilmCategoryList() );
            if ( list != null ) {
                category.getFilmCategoryList().clear();
                category.getFilmCategoryList().addAll( list );
            }
        }
        else {
            List<FilmCategory> list = filmCategoryDtoListToFilmCategoryList( categoryDto.getFilmCategoryList() );
            if ( list != null ) {
                category.setFilmCategoryList( list );
            }
        }
