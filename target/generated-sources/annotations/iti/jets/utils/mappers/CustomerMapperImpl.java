...
public class CustomerMapperImpl implements CustomerMapper {
    ...
    public Customer partialUpdate(CustomerDto customerDto, Customer customer) {
        ...
        if ( customerDto.getStore() != null ) {
            ...
            storeDtoToStore1( customerDto.getStore(), customer.getStore() );
        }
    ...
    protected List<Customer> customerDtoListToCustomerList(List<CustomerDto> list) {
        ...
        for ( CustomerDto customerDto : list ) {
            list1.add( toEntity( customerDto ) );
        }
