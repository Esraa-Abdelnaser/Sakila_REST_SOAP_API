...
public class FilmActorMapperImpl implements FilmActorMapper {
    ...
    protected List<FilmActor> filmActorDtoListToFilmActorList(List<FilmActorDto> list) {
        ...
        for ( FilmActorDto filmActorDto : list ) {
            list1.add( toEntity( filmActorDto ) );
        }
    ...
    protected void actorDtoToActor1(ActorDto actorDto, Actor mappingTarget) {
        ...
        if ( mappingTarget.getFilmActorList() != null ) {
            List<FilmActor> list = filmActorDtoListToFilmActorList( actorDto.getFilmActorList() );
            if ( list != null ) {
                mappingTarget.getFilmActorList().clear();
                mappingTarget.getFilmActorList().addAll( list );
            }
            else {
            ...
            List<FilmActor> list = filmActorDtoListToFilmActorList( actorDto.getFilmActorList() );
            if ( list != null ) {
                mappingTarget.setFilmActorList( list );
            }
        }
    }
