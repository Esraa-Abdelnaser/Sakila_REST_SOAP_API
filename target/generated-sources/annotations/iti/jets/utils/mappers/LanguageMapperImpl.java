...
public class LanguageMapperImpl implements LanguageMapper {
    ...
    public Language partialUpdate(LanguageDto languageDto, Language language) {
        ...
        if ( language.getFilmList() != null ) {
            List<Film> list = filmDtoListToFilmList( languageDto.getFilmList() );
            if ( list != null ) {
                language.getFilmList().clear();
                language.getFilmList().addAll( list );
            }
        }
        else {
            List<Film> list = filmDtoListToFilmList( languageDto.getFilmList() );
            if ( list != null ) {
                language.setFilmList( list );
            }
        }
    ...
    protected Film filmDtoToFilm(FilmDto filmDto) {
        ...
        film.setLanguage( toEntity( filmDto.getLanguage() ) );
        film.setOriginalLanguage( toEntity( filmDto.getOriginalLanguage() ) );
    ...
    protected FilmDto filmToFilmDto(Film film) {
        ...
        filmDto.setLanguage( toDto( film.getLanguage() ) );
        filmDto.setOriginalLanguage( toDto( film.getOriginalLanguage() ) );
